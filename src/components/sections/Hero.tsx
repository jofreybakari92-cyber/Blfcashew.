      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 lg:grid-cols-2">
        ...
        <div className="animate-fade-up">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <a
              href="#products"
              className="group inline-flex items-center gap-2 rounded-full bg-primary px-7 py-4 text-sm font-semibold text-primary-foreground shadow-soft transition-all hover:shadow-glow hover:-translate-x-1"
            >
              {t("hero.orderNow")}
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-7 py-4 text-sm font-semibold text-foreground transition-all hover:border-whatsapp hover:text-foreground"
            >
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.15)] group transition-shadow duration-700 hover:shadow-[0_30px_60px_rgba(0,0,0,0.25)]">
          ...
          <div
            className="absolute -bottom-8 left-8 hidden md:flex items-center gap-0.5 rounded-[1.5rem] border border-white/40 bg-white/30 p-1.5 shadow-[0_8px_30px_rgba(0,0,0,0.12)] backdrop-blur-xl"
